-- ============================================================================
-- P&L rimborsi Amazon allineato a Sellerboard.
--
-- 1. Storna commissione di vendita (+ DSF) su Amazon/eBay/Temu; Etsy no.
-- 2. Recupera il COGS sui resi FBA Amazon (anche status FINANCES),
--    salvo danni/difetti.
-- 3. Fee elaborazione reso FBA solo dal report resi, non sui rimborsi Finances.
-- ============================================================================
...
SELECT
  ...
  CASE
    ...
    WHEN restock.is_sellable AND o.unit_cost_eur IS NOT NULL
